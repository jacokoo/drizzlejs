...
(function(root, factory) {
  ...
  var Application, Base, D, DefaultConfigs, Drizzle, Layout, Loader, Model, Module, ModuleContainer, MultiRegion, Region, Route, Router, SimpleLoader, View, fn1, fn2, idCounter, item, j, l, len, len1, oldReference, pushStateSupported, ref, ref1;
  D = Drizzle = {
    version: '0.2.8'
  };
      ...
      doItem = (function(_this) {
        return function(item, i) {
          ...
          return (D.isArray(item) ? (promises = (function() {
            var l, len1, results;
            results = [];
            for (l = 0, len1 = item.length; l < len1; l++) {
              inArray = item[l];
              args = [inArray];
              if (i > 0) {
                args.push(gots[i - 1]);
    ...
    delegateEvent: function(target) {
      return D.extend(target, {
        ...
        stopListening: function(obj, name, callback) {
          var key, l, len1, len2, m, ref1, ref2, value;
          ...
          for (key in ref2) {
            ...
            for (m = 0, len2 = value.length; m < len2; m++) {
              item = value[m];
  ...
  Drizzle.Base = Base = (function() {
    Base.include = function() {
      var key, l, len1, mixin, mixins, value;
  ...
  D.View = View = (function(superClass) {
        ...
        return function() {
          ...
          for (key in bind) {
            ...
            results.push((function() {
              var len2, m, results1;
              results1 = [];
              for (m = 0, len2 = bindings.length; m < len2; m++) {
                binding = bindings[m];
    ...
    View.prototype.executeIdReplacement = function() {
      var attr, len2, m, ref2, results, used;
      used = {};
    ...
    View.prototype.renderComponent = function() {
      ...
      promises = (function() {
        var len2, m, results;
        results = [];
        for (m = 0, len2 = components.length; m < len2; m++) {
      ...
      return this.chain(promises, (function(_this) {
        return function(comps) {
          var comp, id, len2, m, results;
          results = [];
          for (m = 0, len2 = comps.length; m < len2; m++) {
            comp = comps[m];
            if (!(comp)) {
              continue;
            }
  ...
  Route = (function() {
    ...
    Route.prototype.handle = function(hash) {
      ...
      fns = (function() {
        var len2, m, results;
        results = [];
        for (i = m = 0, len2 = routes.length; m < len2; i = ++m) {
          route = routes[i];
  ...
  D.Router = Router = (function(superClass) {
    ...
    Router.prototype.mountRoutes = function() {
      ...
      return this.chain((function() {
        ...
        var i, len2, m, results, router;
        results = [];
        for (i = m = 0, len2 = routers.length; m < len2; i = ++m) {
          router = routers[i];
  ...
  D.MultiRegion = MultiRegion = (function(superClass) {
    ...
    MultiRegion.prototype.getEl = function(item) {
      ...
      key = (ref2 = item.regionInfo) != null ? ref2.key : void 0;
      if (!key) {
        return null;
      }
    ...
    MultiRegion.prototype.getCurrentItem = function(item, options) {
      ...
      key = D.isString(item) ? options.regionKey : (ref2 = item.regionInfo) != null ? ref2.key : void 0;
      if (key) {
        if (i = this.items[key]) {
          return i;
        } else {
