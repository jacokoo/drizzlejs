...
t.Promise.create(function(e,n){l.Adapter.ajax(i,t).then(function(){for(var n=arguments.length,r=Array(n),o=0;n>o;o++)r[o]=arguments[o];t.set(l.Adapter.ajaxResult(r),!i.slient),e(r)},function(){for(var e=arguments.length,t=Array(e),r=0;e>r;r++)t[r]=arguments[r];return n(t)})})}},l.ComponentManager={_handlers:{},_componentCache:{},setDefaultHandler:function(e){var t=arguments.length<=1||void 0===arguments[1]?function(){}:arguments[1];this._defaultHandler={creator:e,destructor:t}},register:function(e,t){
...
}},{key:"$",value:function(e){return this.$$("#"+this._wrapDomId(e))[0]}},{key:"$$",value:function(e){return this._element.querySelectorAll(e)}},{key:"_render",value:function(e,t){var n=this;return this._region||this._error("Region is null"),this.renderOptions=null==e?this.renderOptions||{}:e,this.chain(this._loadedPromise,this._destroyComponents,function(){return n.trigger("beforeRender")},function(){return n._option("beforeRender")},this._beforeRender,this._serializeData,function(e){return n._renderTemplate(e,t);
...
return this.chain(i(Object.getPrototypeOf(o.prototype),"_beforeRender",this).call(this),function(){return e._store._loadEagerModels()}).then(null,function(){return e.Promise.resolve()})}},{key:"_afterRender",value:function(){var e=this;return this.chain(i(Object.getPrototypeOf(o.prototype),"_afterRender",this).call(this),function(){return e._store._loadLazyModels()}).then(null,function(){return e.Promise.resolve()})}},{key:"store",get:function(){return this._store}}]),o}(l.RenderableContainer);var m=["blur","focus","scroll","resize"];
l.Region=function(n){function i(t,n,o,a){r(this,i);var s=e(this,Object.getPrototypeOf(i).call(this,a||"Region",{},{app:t,module:n,_el:o,_delegated:{}}));return s._el||s._error("The DOM element for region is required"),t.delegateEvent(s),s}return t(i,n),a(i,[{key:"show",value:function(e,t){var n=this;return this._isCurrent(e)?t&&t.forceRender===!1?this.Promise.resolve(this._current):this._current._render(t,!0):this.chain(l.isString(e)?this.app._createModule(e):e,function(e){return e instanceof l.Renderable||n._error("The item is expected to be an instance of Renderable"),
e},[function(e){return n.chain(e._region&&e._region.close(),e)},function(){return n._current&&n.close()}],function(e){var t=o(e,1),r=t[0];n._current=r;var i=r.module?r.module.name+":"+r.name:r.name;return n._getElement().setAttribute("data-current",i),r._setRegion(n),r},function(e){return e._render(t,!1)})}},{key:"close",value:function(){var e=this;return this.chain(this._current&&this._current._close(),function(){return delete e._current},this)}},{key:"$$",value:function(e){return this._getElement().querySelectorAll(e);
...
a(i,[{key:"navigate",value:function(e,t){this._started&&(y?g.history.pushState({},g.document.title,"#"+e):g.location.replace("#"+e),t!==!1&&this._dispath(e))}},{key:"_start",value:function(e){if(!this._started&&g){l.Adapter.addEventListener(g,"hashchange",this._EVENT_HANDLER,!1);var t=this._getHash()||e;this._started=!0,t&&this.navigate(t)}}},{key:"_stop",value:function(){this._started&&(l.Adapter.removeEventListener(g,"hashchange",this._EVENT_HANDLER),this._started=!1)}},{key:"_dispath",value:function(e){
if(e!==this._previousHash){this._previousHash=e;for(var t=0;t<this._routes.length;t++){var n=this._routes[t];if(n.match(e))return void n.handle(e)}}}},{key:"_mountRoutes",value:function(){var e=this,t=c.call(arguments);return this.chain(h(t,function(t){return e.app._getLoader(t).loadRouter(t)}),function(n){return h(n,function(n,r){return e._addRoute(t[r],n)})})}},{key:"_addRoute",value:function(e,t){var n=this,r=t.routes,i=t.interceptors;p(l.isFunction(r)?r.apply(this):r,function(r,i){var o=(e+"/"+i).replace(/^\/|\/$/g,"");
n._routes.unshift(new b(n.app,n,o,t[r]))}),p(l.isFunction(i)?i.apply(this):i,function(r,i){var o=(e+"/"+i).replace(/^\/|\/$/g,"");n._interceptors[o]=t[r]})}},{key:"_getInterceptors",value:function(e){var t=[],n=e.split("/");for(n.pop();n.length>0;){var r=n.join("/");this._interceptors[r]&&t.unshift(this._interceptors[r]),n.pop()}return this._interceptors[""]&&t.unshift(this._interceptors[""]),t}},{key:"_getHash",value:function(){return g.location.hash.slice(1)}}]),i}(l.Base);var O={pageSize:10,pageKey:"_page",
pageSizeKey:"pageSize",recordCountKey:"recordCount",params:function(e){return e}};return l.PageableModel=function(n){function o(t,n){r(this,o);var i=e(this,Object.getPrototypeOf(o).call(this,t,n));return i._data=i._option("data")||[],i._p={page:i._option("page")||1,pageCount:0,pageSize:i._option("pageSize")||O.pageSize,pageKey:i._option("pageKey")||O.pageKey,pageSizeKey:i._option("pageSizeKey")||O.pageSizeKey,recordCountKey:i._option("recordCountKey")||O.recordCountKey},i}return t(o,n),a(o,null,[{
key:"setDefault",value:function(e){f(O,e)}}]),a(o,[{key:"set",value:function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],t=arguments[1];this._p.recordCount=e[this._p.recordCountKey]||0,this._p.pageCount=Math.ceil(this._p.recordCount/this._p.pageSize),i(Object.getPrototypeOf(o.prototype),"set",this).call(this,e,t)}},{key:"clear",value:function(e){this._p.page=1,this._p.recordCount=0,this._p.pageCount=0,i(Object.getPrototypeOf(o.prototype),"clear",this).call(this,e)}},{key:"turnToPage",
value:function(e){return e<=this._p.pageCount&&e>=1&&(this._p.page=e),this}},{key:"firstPage",value:function(){return this.turnToPage(1)}},{key:"lastPage",value:function(){return this.turnToPage(this._p.pageCount)}},{key:"nextPage",value:function(){return this.turnToPage(this._p.page+1)}},{key:"prevPage",value:function(){return this.turnToPage(this._p.page-1)}},{key:"params",get:function(){var e=this._p,t=e.page,n=e.pageKey,r=e.pageSizeKey,a=e.pageSize,s=i(Object.getPrototypeOf(o.prototype),"params",this);
