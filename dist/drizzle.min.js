...
this._p.recordCount=0,this._p.pageCount=0,o.PageableModel.__super__.clear.call(this,t)},turnToPage:function(t){return t<=this._p.pageCount&&t>=1&&(this._p.page=t),this},firstPage:function(){return this.turnToPage(1)},lastPage:function(){return this.turnToPage(this._p.pageCount)},nextPage:function(){return this.turnToPage(this._p.page+1)},prevPage:function(){return this.turnToPage(this._p.page-1)},getPageInfo:function(){var t=this._p,e=t.page,n=t.pageSize,i=t.recordCount,r=t.pageCount,o=void 0;return o=this.data&&this.data.length>0?{
page:e,start:(e-1)*n+1,end:e*n,total:i,pageCount:r}:{page:e,start:0,end:0,total:0,pageCount:r},o.end>o.total&&(o.end=o.total),o}}),o.registerModel("pageable",o.PageableModel),o.MultiRegion=function(){o.MultiRegion.__super__.constructor.apply(this,arguments)},o.extend(o.MultiRegion,o.Region,{_initialize:function(){this._items={},this._elements={}},activate:function(){},show:function(t){var e=this,i=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],r=t.moduleOptions,a=o.isString(t),s=i.key;
a||t instanceof o.Renderable||this._error("The item is expected to be an instance of Renderable"),!s&&r&&r.key&&(s=r.key),s||this._error("Region key is required");var u=this._items[s];return this._isCurrent(s,u,t)?i.forceRender===!1?this.Promise.resolve(u):u.render(i):this.chain(a?this.app._createModule(t):t,[function(t){return e.chain(t._region&&t._region.close(),t)},function(){return e.chain(u&&u._close(),function(){delete e._items[s],delete e._elements[s]})}],function(t){var r=n(t,1),o=r[0],a=o.module?o.module.name+":"+o.name:o.name,u=e._getElement(o,s);
return e._items[s]=o,u.setAttribute("data-current",a),o._setRegion(e),o._render(i,!1)})},_createElement:function(){var t=p.document.createElement("div");return this._el.appendChild(t),t},_getElement:function(t,e){if(!t)return this._el;var n=e||t.renderOptions.key||t.moduleOptions.key;return this._elements[n]||(this._elements[n]=this._createElement(n,t)),this._elements[n]},_isCurrent:function(t,e,n){return!!e&&(e.name===n||n&&n.id===e.id)},_empty:function(t){if(!t)return void o.MultiRegion.__super__._empty.call(this);
var e=this._getElement(t);e.parentNode.removeChild(e)},close:function(){var t=this;return this.chain(u(this._items,function(t){return t._close()}),function(){t._elements={},t._items={},delete t._current},this)}}),r});
