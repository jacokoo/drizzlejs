...
},c(r.RenderableContainer,r.Renderable,{_initialize:function(){var t=r.RenderableContainer.__super__._initialize.call(this);return this.items={},this.chain(t,this._initializeItems)},_afterRender:function(){return this.chain(this._initializeRegions,this._renderItems)},_afterClose:function(){return this._closeRegions()},_initializeItems:function(){var t=this;return this.chain(s(this._option("items"),function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=arguments[1],i=r.isFunction(e)?e.call(t):e;
...
},navigate:function(t,e){this._router&&this._router.navigate(t,e)},dispatch:function(t,e){var n=r.isObject(t)?t.name:t,i=r.isObject(t)?t.payload:e;this.trigger("app."+n,i)},show:function(t,e,n){return this.viewport.regions[t].show(e,n)},_getLoader:function(t,e){return t&&this._loaders[t]||e&&e._loader||this._defaultLoader},_createModule:function(t,e,n){var i=this,o=r.Loader._analyse(t),a=o.name,s=o.loader,u=this._getLoader(s,e);return this.chain(u.loadModule(a),function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};
