...
this.data=this._option("data")||[],this._p={page:this._option("page")||1,pageCount:0,pageSize:this._option("pageSize")||m.pageSize,pageKey:this._option("pageKey")||m.pageKey,pageSizeKey:this._option("pageSizeKey")||m.pageSizeKey,recordCountKey:this._option("recordCountKey")||m.recordCountKey}},l(o.PageableModel,{setDefault:function(t){l(m,t)}}),h(o.PageableModel,o.Model,{set:function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],e=arguments[1];this._p.recordCount=t[this._p.recordCountKey]||0,
