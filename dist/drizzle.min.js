...
var t;return(t=this.Promise).chain.apply(t,arguments)}}),o.Renderable=function(t,e,n,i,r){o.Renderable.__super__.constructor.call(this,t,r,{app:e,module:n,components:{},_loader:i,_componentMap:{},_events:{}}),this._eventHandlers=this._option("handlers"),e.delegateEvent(this)},h(o.Renderable,o.Base,{_initialize:function(){var t=this;return this._templateEngine=this._option("templateEngine")||this.module&&this.module._templateEngine||this.app._templateEngine,this.chain([this._templateEngine._load(this),this._initializeEvents()],function(e){
var i=n(e,1),r=i[0];return t._template=r})},render:function(t){return this._render(null==t?this.renderOptions:t,!0)},$:function(t){return this.$$("#"+this._wrapDomId(t))[0]},$$:function(t){return this._getElement().querySelectorAll(t)},_render:function(t,e){var n=this;return this._region||this._error("Region is null"),this.renderOptions=null==t?this.renderOptions||{}:t,this.chain(this._loadedPromise,this._destroyComponents,function(){return n.trigger("beforeRender")},function(){return n._option("beforeRender");
},this._beforeRender,this._serializeData,function(t){return n._renderTemplate(t,e)},this._renderComponents,this._afterRender,function(){return n._option("afterRender")},function(){return n.trigger("afterRender")},this)},_setRegion:function(t){this._region=t,this._bindEvents()},_close:function(){var t=this;return this._region?this.chain(function(){return t.trigger("beforeClose")},function(){return t._option("beforeClose")},this._beforeClose,[this._unbindEvents,this._destroyComponents,function(){return t._region._empty(t);
}],this._afterClose,function(){return t._option("afterClose")},function(){return t.trigger("afterClose")},function(){return delete t._region},this):this.Promise.resolve(this)},_getElement:function(){return this._region?this._region._getElement(this):null},_serializeData:function(){return{Global:this.app.global,Self:this}},_renderTemplate:function(t,e){this._templateEngine._execute(this,t,this._template,e)},_initializeEvents:function(t){var e=this;u(t||this._option("events"),function(t,n){var i=n.replace(/(^\s+)|(\s+$)/g,"").split(/\s+/),r={
...
var n=t._createRegion(e);t.regions[n.name]=n})})},_renderItems:function(){var t=this;return this.chain(u(this.items,function(e){var n=e.moduleOptions.region;return n?(t.regions[n]||t._error("Region: "+n+" is not defined"),t.regions[n].show(e)):null}),this)},_createRegion:function(t){var e=t.getAttribute("data-region");return this.app._createRegion(t,e,this)},_closeRegions:function(){var t=this.regions;return t?(this.regions={},this.chain(u(t,function(t){return t.close()}),this)):this}}),o.ActionCreator=function(){
...
var e=this;return function(){for(var n=arguments.length,i=Array(n),r=0;r<n;r++)i[r]=arguments[r];if(e._delegated[t]){var a=i[0],u=a.target;s(e._delegated[t].items,function(t){if(!o.Adapter.eventPrevented(a)){for(var n=e._getElement().querySelectorAll(t.selector),r=!1,s=0;s<n.length;s++){var c=n[s];if(c===u||c.contains(u)){r=c;break}}r&&t.fn.apply(t.renderable,i.concat([r]))}})}}},_delegateDomEvent:function(t,e,n,i){var r=this._delegated[e];r||(r=this._delegated[e]={listener:this._createDelegateListener(e),
items:[]},o.Adapter.addEventListener(this._getElement(),e,r.listener,f.indexOf(e)!==-1)),r.items.push({selector:n,fn:i,renderable:t})},_undelegateDomEvents:function(t){var e=this;u(this._delegated,function(n,i){var r=[],a=n;s(a.items,function(e){e.renderable!==t&&r.push(e)}),a.items=r,0===r.length&&(delete e._delegated[i],o.Adapter.removeEventListener(e._getElement(),i,a.listener))})}}),o.TemplateEngine=function(t){o.TemplateEngine.__super__.constructor.call(this,"Template Engine",t,{_templateCache:{}
})},h(o.TemplateEngine,o.Base,{executeIdReplacement:function(t,e){var n=this,i={};s(t.querySelectorAll("[id]"),function(t){var r=t.getAttribute("id");i[r]&&n._error("Dom ID: "+r+" is already used"),i[r]=!0,t.setAttribute("id",e._wrapDomId(r))});var r=this._option("attributesReferToId")||["for","data-target","data-parent"];s(r,function(n){return s(t.querySelectorAll("["+n+"]"),function(t){var i=t.getAttribute(n),r="#"===i.charAt(0),o=r?"#"+e._wrapDomId(i.slice(1)):e._wrapDomId(i);t.setAttribute(n,o);
})})},_load:function(t){var e=t.id;return this._templateCache[e]?this._templateCache[e]:this._templateCache[e]=this._loadIt(t)},_loadIt:function(t){return t instanceof r.Module?t._loader.loadModuleResource(t,"templates"):function(){return t.module._template}},_execute:function(t,e,n){var i=t._getElement();i.innerHTML=n(e),this.executeIdReplacement(i,t)}}),o.Store=function(t,e){var n=this;o.Store.__super__.constructor.call(this,"Store",e,{app:t.app,module:t,models:{}}),this.app.delegateEvent(this),
this._callbacks=this._option("callbacks"),u(this._callbacks,function(t,e){if("app."===e.slice(0,4))return void n.listenTo(n.app,e,function(e){return t.call(n._callbackContext,e)});if("shared."===e.slice(0,7)){var i=e.slice(7),r=n.models[i];r&&r.store!==n||n._error("Can not bind to model: "+e),n.listenTo(r,"changed",function(){return t.call(n._callbackContext)})}})},h(o.Store,o.Base,{dispatch:function(t,e){var n=void 0,i=t,r=e;return o.isObject(i)&&(r=i.payload,i=i.name),n=this._callbacks[i],n||this._error("No action callback for name: "+t),
this.chain(n.call(this._callbackContext,r))},_initialize:function(){this._initializeModels(),this._callbackContext=l({app:this.app,models:this.models,module:this.module,chain:this.chain},o.Request),this._callbackContext.Promise=new o.Promise(this._callbackContext)},_initializeModels:function(){var t=this;u(this._option("models"),function(e,n){var i=(o.isFunction(e)?e.call(t):e)||{};return i.shared===!0?t.app.viewport?void(t.models[n]=t.app.viewport.store.models[n]):(t.module.name===t.app._option("viewport")&&t._error("Can not define shared model in viewport"),
void(t.module.module&&t.module.module.name===t.app._option("viewport")&&(t.models[n]=t.module.module.store.models[n]))):void(t.models[n]=t.app._createModel(t,i))})},_loadEagerModels:function(){var t=this;return this.chain(u(this.models,function(e){return e.store!==t?null:e.options.autoLoad===!0?o.Request.get(e):null}))},_loadLazyModels:function(){var t=this;return this.chain(u(this.models,function(e){if(e.store!==t)return null;var n=e.options.autoLoad;return n&&n!==!0?o.Request.get(e):null}))},_destory:function(){
this.stopListening()}}),o.Model=function(t,e){o.Model.__super__.constructor.call(this,"Model",e,{app:t.module.app,module:t.module,store:t}),this.data=c(this._option("data")),this._idKey=this._option("idKey")||this.app.options.idKey,this.params=l({},this._option("params")),this.app.delegateEvent(this)},o.extend(o.Model,o.Base,{getFullUrl:function(){return o.Request._url(this)},set:function(t,e){var n=this.options.parse?this._option("parse",t):t;this.data=this.options.root?n[this.options.root]:n,e&&this.changed();
},getParams:function(){return this.params},get:function(t){return t?c(this.data):this.data},clear:function(t){this.data=o.isArray(this.data)?[]:{},t&&this.changed()},changed:function(){this.trigger("changed")},_url:function(){return this._option("url")||""}}),o.Loader=function(t,e){o.Loader.__super__.constructor.call(this,"Loader",e,{app:t})},o.assign(o.Loader,{_analyse:function(t){if(!o.isString(t))return{loader:null,name:t};var e=t.split(":"),n=e.length>1?e.shift():null;return{loader:n,name:e.shift(),
args:e}}}),o.extend(o.Loader,o.Base,{loadResource:function(t){var e=this,n=this.app.options,i=n.scriptRoot,r=n.getResource,o=n.amd,a=i+"/"+t;return this.Promise.create(function(t,n){o?require([a],t,n):t(r?r.call(e.app,a):require("./"+a))})},loadModuleResource:function(t,e){return this.loadResource(t.name+"/"+e)},loadModule:function(t){return this.loadResource(t+"/index")},loadView:function(t,e){return this.loadModuleResource(e,"view-"+t)},loadRouter:function(t){var e="router";return this.loadResource(t?t+"/"+e:e);
}}),o.Application=function(t){o.Application.__super__.constructor.call(this,t&&t.name||"Application",l({scriptRoot:"app",urlRoot:"",urlSuffix:"",caseSensitiveHash:!1,container:p&&p.document.body,disabledClass:"disabled",getResource:null,idKey:"id",viewport:"viewport"},t),{global:{},_modules:{},_loaders:{}})},o.extend(o.Application,o.Base,{_initialize:function(){this._templateEngine=this._option("templateEngine")||new o.TemplateEngine,this.registerLoader("default",new o.Loader(this),!0),this._region=this._createRegion(this._option("container"),"Region");
},registerLoader:function(t,e,n){return this._loaders[t]=e,n&&(this._defaultLoader=e),this},start:function(e){var n,i=this;return e&&(this._router=new o.Router(this)),this.chain(!!e&&(n=this._router)._mountRoutes.apply(n,t(this._option("routers"))),this._region.show(this._option("viewport")),function(t){return i.viewport=t},function(){return e&&i._router._start(e)},this)},stop:function(){this.off(),this._region.close(),this._router&&this._router._stop()},navigate:function(t,e){this._router&&this._router.navigate(t,e);
},dispatch:function(t,e){var n=o.isObject(t)?t.name:t,i=o.isObject(t)?t.payload:e;this.trigger("app."+n,i)},show:function(t,e,n){return this.viewport.regions[t].show(e,n)},_getLoader:function(t,e){return t&&this._loaders[t]||e&&e._loader||this._defaultLoader},_createModule:function(t,e){var n=this,i=o.Loader._analyse(t),r=i.name,a=i.loader,s=this._getLoader(a,parent);return this.chain(s.loadModule(r),function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return d.createModule(t.type,r,n,e,s,t);
})},_createView:function(t,e){var n=this,i=o.Loader._analyse(t),r=i.name,a=i.loader,s=this._getLoader(a,e);return this.chain(s.loadView(r,e),function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return d.createView(t.type,r,n,e,s,t)})},_createRegion:function(t,e,n){var i=o.Loader._analyse(e),r=i.name,a=i.loader;return d.createRegion(a,this,n,t,r)},_createStore:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return d.createStore(e.type,t,e)},_createModel:function(t){
var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return d.createModel(e.type,t,e)}}),l(o.Application.prototype,o.Event);var g=p&&p.history&&"pushState"in p.history,v=[/:([\w\d]+)/g,"([^/]+)",/\*([\w\d]+)/g,"(.*)"];l(e.prototype,{match:function(t){return this.pattern.lastIndex=0,this.pattern.test(t)},handle:function(e){var n,i=this;this.pattern.lastIndex=0;var r=this.pattern.exec(e).slice(1),o=this.router._getInterceptors(this.path);return o.push(this.fn),(n=this.router).chain.apply(n,t(s(o,function(t,e){
return function(n){return t.apply(i.router,e>0?[n].concat(r):r)}})))}}),o.Router=function(t){var e=this;o.Router.__super__.constructor.call(this,"Router",{},{app:t,_routes:[],_interceptors:{},_started:!1}),this._prefix=t._option("routerPrefix")||"#!/",this._EVENT_HANDLER=function(){return e._dispath(e._getHash())}},h(o.Router,o.Base,{navigate:function(t,e){this._started&&(g?p.history.pushState({},p.document.title,this._prefix+t):p.location.replace(this._prefix+t),e!==!1&&this._dispath(t))},_start:function(t){
if(!this._started&&p){o.Adapter.addEventListener(p,"hashchange",this._EVENT_HANDLER,!1);var e=this._getHash()||t;this._started=!0,e&&this.navigate(e)}},_stop:function(){this._started&&(o.Adapter.removeEventListener(p,"hashchange",this._EVENT_HANDLER),this._started=!1)},_dispath:function(t){if(t&&t!==this._previousHash){this._previousHash=t;for(var e=0;e<this._routes.length;e++){var n=this._routes[e];if(n.match(t))return void n.handle(t)}}},_mountRoutes:function(){var t=this,e=a.call(arguments);return this.chain(s(e,function(e){
return t.app._getLoader(e).loadRouter(e)}),function(n){return s(n,function(n,i){return t._addRoute(e[i],n)})})},_addRoute:function(t,n){var i=this,r=n.routes,a=n.interceptors;u(o.isFunction(r)?r.apply(this):r,function(r,o){var a=(t+"/"+o).replace(/^\/|\/$/g,"");i._routes.unshift(new e(i.app,i,a,n[r]))}),u(o.isFunction(a)?a.apply(this):a,function(e,r){var o=(t+"/"+r).replace(/^\/|\/$/g,"");i._interceptors[o]=n[e]})},_getInterceptors:function(t){var e=[],n=t.split("/");for(n.pop();n.length>0;){var i=n.join("/");
this._interceptors[i]&&e.unshift(this._interceptors[i]),n.pop()}return this._interceptors[""]&&e.unshift(this._interceptors[""]),e},_getHash:function(){var t=p.location.hash;return t.slice(0,this._prefix.length)!==this._prefix?"":t.slice(this._prefix.length)}});var m={pageSize:10,pageKey:"_page",pageSizeKey:"pageSize",recordCountKey:"recordCount",params:function(t){return t}};return o.PageableModel=function(t,e){o.PageableModel.__super__.constructor.call(this,t,e),this.data=this._option("data")||[],
this._p={page:this._option("page")||1,pageCount:0,pageSize:this._option("pageSize")||m.pageSize,pageKey:this._option("pageKey")||m.pageKey,pageSizeKey:this._option("pageSizeKey")||m.pageSizeKey,recordCountKey:this._option("recordCountKey")||m.recordCountKey}},l(o.PageableModel,{setDefault:function(t){l(m,t)}}),h(o.PageableModel,o.Model,{set:function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],e=arguments[1];this._p.recordCount=t[this._p.recordCountKey]||0,this._p.pageCount=Math.ceil(this._p.recordCount/this._p.pageSize),
o.PageableModel.__super__.set.call(this,t,e)},getParams:function(){var t=this._p,e=t.page,n=t.pageKey,i=t.pageSizeKey,r=t.pageSize,o=this.params;return o[n]=e,o[i]=r,m.params(o)},clear:function(t){this._p.page=1,this._p.recordCount=0,this._p.pageCount=0,o.PageableModel.__super__.clear.call(this,t)},turnToPage:function(t){return t<=this._p.pageCount&&t>=1&&(this._p.page=t),this},firstPage:function(){return this.turnToPage(1)},lastPage:function(){return this.turnToPage(this._p.pageCount)},nextPage:function(){
return this.turnToPage(this._p.page+1)},prevPage:function(){return this.turnToPage(this._p.page-1)},getPageInfo:function(){var t=this._p,e=t.page,n=t.pageSize,i=t.recordCount,r=t.pageCount,o=void 0;return o=this.data&&this.data.length>0?{page:e,start:(e-1)*n+1,end:e*n,total:i,pageCount:r}:{page:e,start:0,end:0,total:0,pageCount:r},o.end>o.total&&(o.end=o.total),o}}),o.registerModel("pageable",o.PageableModel),o.MultiRegion=function(){o.MultiRegion.__super__.constructor.apply(this,arguments)},o.extend(o.MultiRegion,o.Region,{
