(function (drizzlejs) {
    ...
    var o2$4 = SN$4('div', null, KV$5('class', 'sidebar pure-u-1 pure-u-md-1-5'));
    var o3$4 = SN$4('div', null, KV$5('class', 'header'));
    var o4$4 = SN$4('h1', null, KV$5('class', 'brand-title'));
    var o5$4 = TX$4('Drizzle');
    var o6$4 = SN$4('h2', null, KV$5('class', 'brand-tagline'));
    var o7$4 = TX$4('demo kit');
    var o8$3 = SN$4('nav', null, KV$5('class', 'nav'));
    var o9$2 = SN$4('ul', null, KV$5('class', 'nav-list'));
    var o10$2 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o11$2 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o12$2 = TX$4('TODOS');
    var o13$2 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o14$2 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o15$2 = TX$4('TODOS');
    var o16$2 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o17$2 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o18$2 = TX$4('TODOS');
    var o19$1 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o20$1 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o21$1 = TX$4('TODOS');
    var o22$1 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o23$1 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o24$1 = TX$4('TODOS');
    var o25$1 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o26$1 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o27$1 = TX$4('TODOS');
    var o28$1 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o29$1 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o30$1 = TX$4('TODOS');
    var o31$1 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o32$1 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o33$1 = TX$4('TODOS');
    var o34$1 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o35$1 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o36$1 = TX$4('TODOS');
    var o37$1 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o38$1 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o39$1 = TX$4('TODOS');
    var o40$1 = SN$4('li', null, KV$5('class', 'nav-item'));
    var o41$1 = SN$4('a', null, KV$5('class', 'pure-button'));
    var o42$1 = TX$4('TODOS');
    var o43$1 = SN$4('div', null, KV$5('class', 'content pure-u-1 pure-u-md-4-5'));
    var o44$1 = TX$4('b');
    C$5(o4$4, o5$4);
    C$5(o6$4, o7$4);
    C$5(o11$2, o12$2);
    ...
    C$5(o41$1, o42$1);
    C$5(o40$1, o41$1);
    C$5(o9$2, o10$2, o13$2, o16$2, o19$1, o22$1, o25$1, o28$1, o31$1, o34$1, o37$1, o40$1);
    C$5(o8$3, o9$2);
    C$5(o3$4, o4$4, o6$4, o8$3);
    C$5(o2$4, o3$4);
    C$5(o43$1, o44$1);
    C$5(o1$5, o2$4, o43$1);
