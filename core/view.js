  ...
  return View = (function(_super) {
    ...
    View.ComponentManager = {
      ...
      create: function(view, options) {
        ...
        dom = selector ? view.$$(selector) : id ? view.$(id) : view.region.getEl();
        handler = this.handlers[name] || {
          ...
          destructor: function(view, info) {
            return el[name]('destroy');
          },
          initialized: true
        };
              ...
              _results1.push((function(binding) {
                ...
                listener = {
                  ...
                  fn: function() {
                    ...
                    return (_ref1 = _this[method]) != null ? _ref1.apply(_this, args) : void 0;
                    return (_ref2 = _this.eventHandlers[method]) != null ? _ref2.apply(_this, args) : void 0;
    ...
    View.prototype.executeTemplate = function(data, ignore, deferred) {
      ...
      return this.region.attachHtml(html);
    };
