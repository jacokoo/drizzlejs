...
exports.customEvents = template_1.customEvents;
...
exports.components = context_1.components;
exports.helpers = context_1.helpers;
...
const innerHelpers = {
    echo: helper_1.EchoHelper, if: helper_1.IfHelper, unless: helper_1.UnlessHelper
};
const loaders = {
    default: loader_1.Loader
};
exports.loaders = loaders;
// nodes
const SN = (name, id) => new static_node_1.StaticNode(name, id);
const DN = (name, id) => new dynamic_node_1.DynamicNode(name, id);
...
exports.lifecycles = { module: [], view: [] };
exports.factory = {
